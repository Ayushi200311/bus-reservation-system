...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: COLORS.background, padding: 20, justifyContent: 'center' },
  title: { color: COLORS.text, fontSize: 32, fontWeight: '700', textAlign: 'center', marginBottom: 10 },
  subtitle: { color: COLORS.muted, fontSize: 16, textAlign: 'center', marginBottom: 40 },
  form: { width: '100%' },
