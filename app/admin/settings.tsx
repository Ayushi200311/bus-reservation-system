...
export default function AdminSettings() {
  ...
  const MenuItem = ({ title, icon, onPress, color = '#fff' }) => (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ padding: 20 }}>
        <MenuItem
          ...
          onPress={() => router.push('/admin/manage-admins')}
        />
        <MenuItem
          title="Database Backup"
          icon="cloud-upload-outline"
          onPress={() => Alert.alert('Info', 'Connect this to your backup script.')}
        />
        <MenuItem
        ...
        <TouchableOpacity
          style={[styles.item, { marginTop: 40, borderColor: '#FF1E1E' }]}
